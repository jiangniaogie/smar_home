...
void TIM3_PWM_Init(u32 arr, u32 psc)
{
    ...
    GPIO_PinAFConfig(GPIOC, GPIO_PinSource8, GPIO_AF_TIM3); //GPIOC6复用为定时器3
//    GPIO_PinAFConfig(GPIOC, GPIO_PinSource9, GPIO_AF_TIM3); //GPIOC6复用为定时器3
    ...
    GPIO_Init(GPIOC, &GPIO_InitStructure);             //初始化PB14
